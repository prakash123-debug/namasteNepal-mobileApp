...
Widget showArticleList(BuildContext context, Article article) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${Provider.of<ArticleCategoryProvider>(context).getCategoryById(article.articleCategoryId).categoryName}",
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                                color: Theme.of(context).primaryColor),
