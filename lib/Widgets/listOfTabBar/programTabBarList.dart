...
Widget showProgramList(BuildContext context, Program program) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${Provider.of<ArticleCategoryProvider>(context).getCategoryById(program.programCategoryId).categoryName}",
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                                color: Theme.of(context).primaryColor),
